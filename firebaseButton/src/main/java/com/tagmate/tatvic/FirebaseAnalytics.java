...
public class FirebaseAnalytics {
    ...
    private static FirebaseAnalytics fInstance;
    ...
    private FirebaseAnalytics(Context context) {
        ...
        //appInstanceId
        com.google.firebase.analytics.FirebaseAnalytics.getInstance(context).getAppInstanceId()
    ...
    public static FirebaseAnalytics getInstance(Context context) {
        if (fInstance == null) {
            ...
            fInstance = new FirebaseAnalytics(context);
        }
        return fInstance;
    }
...
//        bundle = bundle;
        ...
        if(sharedPreferences.getBoolean("SERVER_STATUS", false)){
            ...
            bundle2.putString("app_instnce_id",sharedPreferences.getString("APP_INSTANCE_ID",""));
            ...
            executorService.submit(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        String json = "{\"event_name\":"+ "\""+eventName +"\""+","+
                                "\"params\":"+ utils.bundleToJsonString3(bundle)+","+
                                "\"meta\":"+ utils.bundleToJsonString3(bundle2)+
                                "}";
